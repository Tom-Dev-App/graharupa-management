...
<section class="min-h-screen">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <form class="mt-3" action="{{ '' }}" method="POST">
                                       ...
                                       {{-- status --}}
                                        <div>
                                            <label class="block mb-2 font-medium text-gray-700 dark:text-zinc-100">Select Status</label>
                    ...
                    <div class="col-span-6 lg:col-span-6">
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <form action="{{ $user->trashed() ? route('users.restore', $user->id) : route('users.suspend', $user->id) }}" method="POST">
                                    @csrf
                                                ...
                                                <div class="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl -top-10 sm:my-8 sm:w-full sm:max-w-lg dark:bg-zinc-700">
                                                    <div class="p-5 text-center bg-white dark:bg-zinc-700">
                                                        @if ($user->trashed())
                                                            ...
                                                            <p class="mt-2 text-gray-500 dark:text-zinc-100/60">By restoring the account, the user will be able to use this account.</p>
                                                            <div class="justify-center px-4 py-3 mt-5 border-gray-50 sm:flex sm:px-6">
                                                                ...
                                                                <button type="submit" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-green-500 border border-transparent rounded-md shadow-sm btn hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">Activate</button>
                                                            </div>
                                                        @else
                                                            ...
                                                            <p class="mt-2 text-gray-500 dark:text-zinc-100/60">By suspending the user account, the user will not be able to use this account.</p>
                                                            <div class="justify-center px-4 py-3 mt-5 border-gray-50 sm:flex sm:px-6">
                                                                <button type="button" class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm btn dark:text-gray-100 hover:bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-gray-500/30 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm dark:bg-zinc-700 dark:border-zinc-600 dark:hover:bg-zinc-600 dark:focus:bg-zinc-600 dark:focus:ring-zinc-700 dark:focus:ring-gray-500/20" data-tw-dismiss="modal">Cancel</button>
                                                                <button type="submit" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-red-500 border border-transparent rounded-md shadow-sm btn hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">Suspend</button>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
